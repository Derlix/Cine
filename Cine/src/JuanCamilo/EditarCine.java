...
public class EditarCine extends javax.swing.JFrame {
    BaseDatosJuanPrincipal basedatos;

    public EditarCine(BaseDatosJuanPrincipal basedatos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btn_editar_cine = new javax.swing.JButton();
        ...
        btn_editar_cine.setBackground(new java.awt.Color(0, 255, 0));
        btn_editar_cine.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btn_editar_cine.setForeground(new java.awt.Color(255, 255, 255));
        btn_editar_cine.setText("EDITAR");
        btn_editar_cine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_editar_cineActionPerformed(evt);
            }
        });

        etq_buscar.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        etq_buscar.setText("Ingresa el Identificador del cine");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(178, 178, 178))
                                .addComponent(campoNombre, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(campoCiudad, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(35, 35, 35)
                                        .addComponent(btn_editar_cine)))
                                .addGap(53, 53, 53)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_buscar, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE))
                .addGap(24, 24, 24)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(etq_nombre)
                    .addComponent(etq_direccion))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_editar_cine, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_editar_cineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editar_cineActionPerformed
        String nombre = campoNombre.getText();
        String ciudad = campoCiudad.getText();
        String pais = campoPais.getText();
        String direccion = campoDireccion.getText();

        if (nombre.isEmpty() || ciudad.isEmpty() || pais.isEmpty() || direccion.isEmpty() || campoBuscar.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Todos los campos deben estar llenos.", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                int idCine = Integer.parseInt(campoBuscar.getText());
                // Actualizar el cine
                basedatos.actualizarCine(idCine, nombre, direccion, ciudad, pais);
                JOptionPane.showMessageDialog(this, "Cine actualizado correctamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
                limpiarCampos();
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "ID debe ser un número válido.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_btn_editar_cineActionPerformed
    ...
    public void eventosMouse(){
        ...
        btn_editar_cine.addMouseListener(new MouseAdapter() {
            @Override
            // Evento cambio de color cuando se pasa el mouse por el boton
            public void mouseEntered(MouseEvent e) {
                btn_editar_cine.setBackground(customColor);
                btn_editar_cine.setCursor(new Cursor(Cursor.HAND_CURSOR));
                btn_editar_cine.setForeground(Color.WHITE);
            }
            // Volver al color predeterminado cuando el raton sale del botón
            @Override
            public void mouseExited(MouseEvent e) {
                btn_editar_cine.setBackground(Color.WHITE);
                btn_editar_cine.setForeground(Color.BLACK);
            }
            // Establecer el color personalizado cuando se hace clic en cualquier botón
            @Override
            public void mouseClicked(MouseEvent e) {
    ...
    private javax.swing.JButton btn_editar_cine;
